...
export class SettingsManager {
  ...
  getHistory() {
    try {
      return JSON.parse(
        this._settings.get_string(SettingsKeys.HISTORY) || "[]",
      );
    } catch (e) {
  ...
  getStyleSettings() {
    return {
      humanMessageColor: this._settings.get_string(
        SettingsKeys.HUMAN_MESSAGE_COLOR,
      ),
      llmMessageColor: this._settings.get_string(
        SettingsKeys.LLM_MESSAGE_COLOR,
      ),
      humanMessageTextColor: this._settings.get_string(
        SettingsKeys.HUMAN_MESSAGE_TEXT_COLOR,
      ),
      llmMessageTextColor: this._settings.get_string(
  ...
  /**
   * Get tool server URL
   * @returns {string} - Tool server URL
   */
  getToolServerUrl() {
    return this._settings.get_string(SettingsKeys.TOOL_SERVER_URL);
  }
   ...
   */
  getWeatherLatitude() {
    return this._settings.get_double(SettingsKeys.WEATHER_LATITUDE);
  }
   ...
   */
  getWeatherLongitude() {
    return this._settings.get_double(SettingsKeys.WEATHER_LONGITUDE);
  }
  ...
  setStyleSettings(styleSettings) {
    if (styleSettings.humanMessageColor) {
      this._settings.set_string(
        SettingsKeys.HUMAN_MESSAGE_COLOR,
        styleSettings.humanMessageColor,
      );
    }
    ...
    if (styleSettings.humanMessageTextColor) {
      this._settings.set_string(
        SettingsKeys.HUMAN_MESSAGE_TEXT_COLOR,
        styleSettings.humanMessageTextColor,
      );
    }
    ...
    if (styleSettings.llmMessageTextColor) {
      this._settings.set_string(
        SettingsKeys.LLM_MESSAGE_TEXT_COLOR,
        styleSettings.llmMessageTextColor,
      );
    }
  }
